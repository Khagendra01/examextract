...
def build_exam_docx(output_path: str):
    ...
    st_q.paragraph_format.space_before = Pt(2)
    st_q.paragraph_format.space_after = Pt(2)
    st_q.paragraph_format.line_spacing_rule = WD_LINE_SPACING.EXACTLY
    st_q.paragraph_format.line_spacing = Pt(12)
    ...
    st_opt.paragraph_format.space_before = Pt(2)
    st_opt.paragraph_format.space_after = Pt(2)
    st_opt.paragraph_format.line_spacing_rule = WD_LINE_SPACING.EXACTLY
    st_opt.paragraph_format.line_spacing = Pt(12)
